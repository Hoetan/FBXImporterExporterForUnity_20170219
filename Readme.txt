...
FBX Importer & Exporter for Unity β Trial Version 2017/02/19
...
■使用ライブラリ(DLL)
 ...
 FBX SDK 2017.1 VS2015 (64bit): http://www.autodesk.com/products/fbx/overview

※「DllNotFoundException: Assets/FBXImporter&ExporterForUnity/FBXImporterForUnity/Plugins/x86_64/FBXImporterForUnity.dll」
※「DllNotFoundException: Assets/FBXImporter&ExporterForUnity/FBXExporterForUnity/Plugins/x86_64/FBXExporterForUnity.dll」

　のエラーがでた場合は、上記のＳＤＫにあるＤＬＬのコピーが必須です。
　「C:\Program Files\Autodesk\FBX\FBX SDK\2017.1\lib\vs2015\x64\release\libfbxsdk.dll」を、Unityプロジェクトのルート（※）へコピーしてください。
...
Copy the DLL found from this path, "C:\Program Files\Autodesk\FBX\FBX SDK\2017.1\lib\vs2015\x64\release\libfbxsdk.dll", to the root (*) of the Unity project.
